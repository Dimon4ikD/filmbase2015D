...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { film_id: @banner.film_id, frequency: @banner.frequency, image: @banner.image }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { film_id: @banner.film_id, frequency: @banner.frequency, image: @banner.image }
    assert_redirected_to banner_path(assigns(:banner))
  end
